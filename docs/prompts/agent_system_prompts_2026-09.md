# Agent system prompts — Phase A baseline (2026-09)

> Generated by `tool/export_spec_inputs.py` from `functions/prompts/*.txt` (commit `51fd50e`). Do not edit by hand; edit the `.txt` and re-run.

| file | promptVersion | SHA-256 |
| --- | --- | --- |
| `functions/prompts/siu_yan_v1.txt` | `siu_yan_v1@2026-06` | `7f77797921ed36086abcd1740bd40d0edd6c205509cb9a027172316b5ec78290` |
| `functions/prompts/ah_jan_ah_bak_v1.txt` | `ah_jan_ah_bak_v1@2026-09` | `8efcae4cd46ba28f219bb0e49c6f533d5877950ffb21da5e29c8a73e148d6347` |
| `functions/prompts/tung_tung_v1.txt` | `tung_tung_v1@2026-06` | `251584dc7f1e503d63dc81e78b823e541342a75b9f7ed8b88d4457053bc08ecc` |
| `docs/prompts/context_suffix_template.txt` | — | `a068c471634e6577a47eec379578334318d100df228ca1fed4e416c0702b2a22` |

Temperatures (functions/index.js `_AGENT_TEMPERATURE`): siu_yan 0.7 · ah_jan_ah_bak 0.5 · tung_tung 0.85; `max_tokens 800`, `top_p 0.95`.
