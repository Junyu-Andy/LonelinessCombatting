...
| - | --- | --- | --- | --- |
| 1a | `assets/images/greeting_morning.png` | `lib/features/home/presentation/pages/home_page.dart` — `_GreetingHero` left 108 × 108 container (05:00–10:59) | 108 × 108 | Morning sun rising through curtains, warm golden light. Square format, transparent background. |
| 1b | `assets/images/greeting_noon.png` | Same file — noon variant (11:00–13:59) | 108 × 108 | High noon bright sky, a cup of tea on a sunlit windowsill. Square, transparent. |
| 1c | `assets/images/greeting_afternoon.png` | Same file — afternoon variant (14:00–17:59) | 108 × 108 | Soft clouds, gentle afternoon light, a person stretching at a desk. Square, transparent. |
| 1d | `assets/images/greeting_evening.png` | Same file — evening variant (18:00–21:59) | 108 × 108 | City lights outside a window, warm lamp glow, dusk sky. Square, transparent. |
| 1e | `assets/images/greeting_night.png` | Same file — late night variant (22:00–04:59) | 108 × 108 | Crescent moon and stars, a cosy blanket, midnight-blue sky. Square, transparent. |
